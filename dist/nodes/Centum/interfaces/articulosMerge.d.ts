...
export declare enum AbreviaturaMerge {
    Col = "COL",
    Med = "MED"
}
export declare enum AtributosArticuloNombreMerge {
    Color = "COLOR ",
    Medidas = "MEDIDAS"
}
...
export declare enum DetalleMerge {
...
export declare enum CodigoMerge {
    Captor = "Captor",
    CodigoCaptor = "Captor ",
    CodigoEnya = "Enya",
    Dib = "Dib",
...
export declare enum RubroCodigoMerge {
    R01 = "R01",
    R02 = "R02",
    R03 = "R03",
    R04 = "R04",
...
export declare enum RubroNombreMerge {
    Alfombras = "ALFOMBRAS",
    Cortinas = "CORTINAS",
    Deco = "DECO",
...
export declare enum SociedadArticuloNombreMerge {
...
export declare enum SubRubroNombreMerge {
    Adhesivos = "ADHESIVOS",
    Alfombras = "ALFOMBRAS",
