...
const getArticulo: INodeProperties[] = [
	...
	},
	{
		...
		default: false,
		description:
			'Cuando está activo devuelve solo la primera respuesta sin expandir variantes por grupo',
		displayOptions: { show: { operation: ['listarProductosDisponibles'] } },
	},
	{
	...
	},
	{
		...
		type: 'boolean',
		default: false,
		description: 'Return a lighter response with only the most useful top-level fields',
		displayOptions: {
			show: {
				operation: [
					'buscarProductos',
		...
		options: [
			{
				...
				options: [
					...
					},
					{
						...
						value: 'all',
						description:
							'Trae todos los ítems paginando internamente sin opción de modificar cantidad por página ni intervalo',
					},
				],
				default: 'custom',
			...
			},
			{
				...
				description:
					'Número de página desde donde comenzar la paginación (por defecto comienza desde la página 1)',
			},
		],
		displayOptions: {
			show: {
