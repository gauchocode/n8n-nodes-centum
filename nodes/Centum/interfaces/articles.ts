...
export enum CategoriaImpuestoIVANombre {
	Iva2100 = 'IVA 21.00',
}
...
export enum SociedadArticuloNombre {
...
export enum AtributoArticuloNombre {
	Color = 'COLOR ',
	Medidas = 'MEDIDAS',
}
